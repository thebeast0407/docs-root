...
That is, it's a "big data" database with some blockchain characteristics added, including `decentralization <https://bigchaindb.readthedocs.io/projects/server/en/latest/topic-guides/decentralized.html>`_, 
`immutability <https://bigchaindb.readthedocs.io/projects/server/en/latest/topic-guides/immutable.html>`_ 
and 
